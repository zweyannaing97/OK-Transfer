...
import {mytelbaseTotal_ChartOptions} from "../index-dashboard/index-dashboard.component";
...
@Component({
  selector: 'app-mytel-month-chart',
  templateUrl: './mytel-month-chart.component.html',
  styleUrls: ['./mytel-month-chart.component.scss']
})
export class MytelMonthChartComponent implements OnInit {
