...
import {ooredoobaseTotal_ChartOptions} from "../index-dashboard/index-dashboard.component";

@Component({
  selector: 'app-ooredoo-month-chart',
  templateUrl: './ooredoo-month-chart.component.html',
  styleUrls: ['./ooredoo-month-chart.component.scss']
})
export class OoredooMonthChartComponent implements OnInit {
