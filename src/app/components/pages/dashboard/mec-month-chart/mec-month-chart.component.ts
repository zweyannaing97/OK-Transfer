...
import {mecbaseTotal_ChartOptions} from "../index-dashboard/index-dashboard.component";
...
@Component({
  selector: 'app-mec-month-chart',
  templateUrl: './mec-month-chart.component.html',
  styleUrls: ['./mec-month-chart.component.scss']
})
export class MecMonthChartComponent implements OnInit {
