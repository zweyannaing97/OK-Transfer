...
import {telenorbaseTotal_ChartOptions} from "../index-dashboard/index-dashboard.component";
...
@Component({
  selector: 'app-telenor-month-chart',
  templateUrl: './telenor-month-chart.component.html',
  styleUrls: ['./telenor-month-chart.component.scss']
})
export class TelenorMonthChartComponent implements OnInit {
