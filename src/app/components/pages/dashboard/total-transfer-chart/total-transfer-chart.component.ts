...
import {monthBaseTotal_ChartOptions} from "../index-dashboard/index-dashboard.component";
...
@Component({
  selector: 'app-total-transfer-chart',
  templateUrl: './total-transfer-chart.component.html',
  styleUrls: ['./total-transfer-chart.component.scss']
})
export class TotalTransferChartComponent implements OnInit {
