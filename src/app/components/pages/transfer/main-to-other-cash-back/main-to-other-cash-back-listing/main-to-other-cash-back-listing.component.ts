...
import {MainToOtherCashFilterComponent} from "../../../../modal/transfer-modal/main-to-other-cash-filter/main-to-other-cash-filter.component";

@Component({
  selector: 'app-main-to-other-cash-back-listing',
  templateUrl: './main-to-other-cash-back-listing.component.html',
  styleUrls: ['./main-to-other-cash-back-listing.component.scss']
})
export class MainToOtherCashBackListingComponent implements OnInit {

  constructor(public dialog: MatDialog) {}

  openDialog() {
    this.dialog.open(MainToOtherCashFilterComponent, {
      width: '1000px',
      data: {}
    });
  }
  ...
  displayedColumns: string[] = ['merchantAccNumber', 'merchantAccName', 'transactionId','otherCashNo','otherCashname','transferAmnt', 'dateTime'];
